...
export default function ProfileSection() {
  return (
    <section
      id="about"
      className="py-16 xl:py-24 px-4 xl:px-8 bg-accent/30"
    >
      <div className="container mx-auto">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          >
            {/* Glow border */}
            <div className="absolute inset-0 bg-gradient-to-br from-primary/30 via-transparent to-secondary/30 opacity-0 group-hover:opacity-100 blur-2xl transition-opacity duration-500" />

            <CardContent className="relative p-6 xl:p-8 space-y-4 text-foreground/90">

              <p className="text-base xl:text-lg leading-relaxed">
                I am a{" "}
                <span className="font-semibold text-primary">self-motivated</span>{" "}
                and{" "}
              ...
              <p className="text-base xl:text-lg leading-relaxed">
                ...
                ever-evolving web development landscape. My attention to detail
                and problem-solving skills enable me to deliver high-quality
              ...
              <p className="text-base xl:text-lg leading-relaxed">
                ...
                Whether it’s translating design mockups into pixel-perfect
                interfaces or optimizing application performance, I am committed
